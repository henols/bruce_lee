...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/workspaces/bruce_lee/.claude/.gsd-surface.json`
(sibling to `/workspaces/bruce_lee/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/workspaces/bruce_lee/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/workspaces/bruce_lee/.claude/skills`).
...
`/workspaces/bruce_lee/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/workspaces/bruce_lee/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/workspaces/bruce_lee/.claude/.gsd-surface.json`
Install profile marker: `/workspaces/bruce_lee/.claude/.gsd-profile`
Skill dirs: `/workspaces/bruce_lee/.claude/skills/gsd-*/`
Engine module: `/workspaces/bruce_lee/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/workspaces/bruce_lee/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
