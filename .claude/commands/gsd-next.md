...
<execution_context>
@/workspaces/bruce_lee/.claude/gsd-core/workflows/smart-entry.md
...
<process>
Follow /workspaces/bruce_lee/.claude/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
