...
<required_reading>
@/workspaces/bruce_lee/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspaces/bruce_lee/.claude
                  → checks /workspaces/bruce_lee/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspaces/bruce_lee/.claude/gsd-core
                  → writes to /workspaces/bruce_lee/.claude/gsd-core/hooks/
...
@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-bug-taxonomy.md
...
@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-repro-hardening.md
...
@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-semantic-recall.md
...
@/workspaces/bruce_lee/.claude/gsd-core/references/thinking-models-debug.md
...
@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-sbfl.md
...
- Read @/workspaces/bruce_lee/.claude/gsd-core/references/common-bug-patterns.md
...
@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-rca-branching.md
...
@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-fix-acceptance.md
...
@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@/workspaces/bruce_lee/.claude/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
