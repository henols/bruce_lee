...
Reference full template: `/workspaces/bruce_lee/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/bruce_lee/.claude/gsd-core/templates/state.md`.
