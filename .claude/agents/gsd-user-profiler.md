...
<reference>
@/workspaces/bruce_lee/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/workspaces/bruce_lee/.claude/gsd-core/references/user-profiling.md` to load:
