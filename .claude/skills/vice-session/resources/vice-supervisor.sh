...
# would be a regression: .claude/skills/vice-session/scripts/vice.mjs's withReconnect() retries transport
...
# that .claude/skills/vice-session/scripts/vice.mjs's readEpoch() reads from the container side, so the
...
"epoch" that the container-side harness (.claude/skills/vice-session/scripts/vice.mjs's readEpoch()) uses
...
echo "vice-supervisor: the container-side harness (.claude/skills/vice-session/scripts/vice.mjs's readEpoch())"
