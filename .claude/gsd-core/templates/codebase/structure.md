...
- Usage: Reference from command with `@/workspaces/bruce_lee/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /workspaces/bruce_lee/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /workspaces/bruce_lee/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
