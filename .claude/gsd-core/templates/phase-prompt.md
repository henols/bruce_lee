...
<!-- For checkpoint task examples and patterns, see @/workspaces/bruce_lee/.claude/gsd-core/references/checkpoints.md -->
...
See `/workspaces/bruce_lee/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/workspaces/bruce_lee/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/workspaces/bruce_lee/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
