...
See /workspaces/bruce_lee/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /workspaces/bruce_lee/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /workspaces/bruce_lee/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /workspaces/bruce_lee/.claude/gsd-core/templates/discovery.md
...
Use /workspaces/bruce_lee/.claude/gsd-core/templates/discovery.md.
