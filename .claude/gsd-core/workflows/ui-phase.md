...
```markdown
Read /workspaces/bruce_lee/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /workspaces/bruce_lee/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /workspaces/bruce_lee/.claude/agents/gsd-ui-checker.md for instructions.
...
@/workspaces/bruce_lee/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /workspaces/bruce_lee/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/workspaces/bruce_lee/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/workspaces/bruce_lee/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
