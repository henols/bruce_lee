...
```
Agent(
  prompt="Read /workspaces/bruce_lee/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/workspaces/bruce_lee/.claude/gsd-core/templates/SECURITY.md`
